                              ...
                              if (as[j].innerHTML.indexOf("l-i-n-u-x") !== -1) {
                                ...
                                if (as[j].innerHTML.indexOf("j-a-v-a-s-c-r-i-p-t") !== -1) {
                                  ...
                                  if (as[j].innerHTML.indexOf("k-o-t-l-i-n") !== -1) {
                                    ...
                                    if (as[j].innerHTML.indexOf("s-w-i-f-t") !== -1) {
                                      as[
                                        j
                                      ].innerHTML = `<div style="display:flex;"><img style="margin-right:8px;width:10;height:10" src="/icon/swift.svg" alt="null" p-id="1416">Swift<div>`;
                                    }
            }
          }
        }
